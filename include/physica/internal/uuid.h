...
namespace phys::internal
{
   ...
   public:
      ...
      uuid(const uuid &rhs) : mostSignificantBits_(rhs.mostSignificantBits_), leastSignificantBits_(rhs.leastSignificantBits_)
      {
      }
      ...
      const size_t msb() const
      {
         return mostSignificantBits_;
      }

      const size_t lsb() const
      {
